...
const Mission = () => {
  ...
  return (
    <Container className='mission p-5'>
          <Row className="">
            {mission.map((item, index) => 
             <Col md={4} data-aos="fade-up" key={index}>
             <Card className='p-3 border-none' style={{boxShadow: '0 2px 16px rgba(182,75,72,0.08)', borderRadius: '1rem'}}>
